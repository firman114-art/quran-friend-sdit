...
export const SURAH_LIST = [
  ...
  'Al-Humazah', 'Al-Asr', 'At-Takatsur', 'Al-Qariah', 'Al-Adiyat',
  'Az-Zalzalah', 'Al-Bayyinah', 'Al-Qadr', 'Al-Alaq', 'At-Tin',
  'Al-Insyirah', 'Ad-Dhuha', 'Al-Lail', 'Asy-Syams', 'Al-Balad',
  'Al-Fajr', 'Al-Ghasyiyah', 'Al-Ala', 'At-Tariq', 'Al-Buruj',
  'Al-Insyiqaq', 'Al-Muthaffifin', 'Al-Infithar', 'At-Takwir', 'Abasa',
  'An-Naziat', 'An-Naba',
  'Juz 30 (Juz Amma)', 'Juz 29', 'Juz 28',
];
